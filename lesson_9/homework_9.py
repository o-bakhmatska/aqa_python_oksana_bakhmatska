class Rhombus:
    ...
    def __setattr__(self, key, value):
        if key == "side_a":
            ...
            if not (self.angle_a + value == 180):
                print("НЕ МОЖНА змінити кут. Сума кутів α і β повинна дорівнювати 180°.")
            else:
                super().__setattr__(key, value)
...
print("\nЗмінюю кут 'β' на НЕ валідне значення:")
r1.angle_b = 180
print(r1.display_info())

print("\nЗмінюю кут 'α' на НЕ валідне значення:")
r1.angle_a = 181
print(r1.display_info())

print("\nЗмінюю кут 'α' на валідне значення:")
r1.angle_a = 150
print(r1.display_info())

print("\nЗмінюю сторону 'а' на НЕ валідне значення:")
r1.side_a = -15
print(r1.display_info())
